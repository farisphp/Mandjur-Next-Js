    ...
    return (
        ...
        <div className="wrapper">
            <div className="page">
                ...
                <a href="https://www.mandjur.co.id/penyakit-ringan/gangguan-kencing/prostat-159">
                ...
                <a href="https://www.mandjur.co.id/obat-luka/luka-bakar">
                <span>Luka Bakar</span>
                </a>
                </li><li className="level1 nav-2-2">
                <a href="https://www.mandjur.co.id/obat-luka/luka-dalam">
                <span>Luka Dalam</span>
                </a>
                </li><li className="level1 nav-2-3">
                <a href="https://www.mandjur.co.id/obat-luka/luka-luar">
                <span>Luka Luar</span>
                </a>
                </li><li className="level1 nav-2-4">
                <a href="https://www.mandjur.co.id/obat-luka/obat-gosok">
                <span>Obat Gosok</span>
                </a>
                </li><li className="level1 nav-2-5">
                <a href="https://www.mandjur.co.id/obat-luka/bekas-luka">
                <span>Obat Bekas Luka</span>
                </a>
                </li><li className="level1 nav-2-6">
                <a href="https://www.mandjur.co.id/obat-luka/operasi">
                <span>Operasi</span>
                </a>
                </li><li className="level1 nav-2-7">
                <a href="https://www.mandjur.co.id/obat-luka/patah-tulang">
                <span>Patah Tulang</span>
                </a>
                </li><li className="level1 nav-2-8 last">
                <a href="https://www.mandjur.co.id/obat-luka/sehabis-melahirkan">
